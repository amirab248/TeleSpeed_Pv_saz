...
define('BOT_TOKEN', '216480965:AAGZPLJSG1Iv4d5ARNZ1Lfpo1D8uLfyHmX0');
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://lolesloles-lolslols.c9users.io/'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://lolesloles-lolslols.c9users.io/'.$chat_id.'/pvresan.php');
...
.";
    ...
    $bot_url    = "https://api.telegram.org/bot216480965:AAGZPLJSG1Iv4d5ARNZ1Lfpo1D8uLfyHmX0/"; 
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://lolesloles-lolslols.c9users.io/'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=pvresanbot
